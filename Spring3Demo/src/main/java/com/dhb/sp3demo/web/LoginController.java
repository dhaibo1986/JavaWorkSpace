...
import com.dhb.sp3demo.service.UserService;
...
public class LoginController {
	...
	public ModelAndView loginCheck(HttpServletRequest request,LoginCommand loginCommand){
		boolean isValidUser = this.userService.hasMatchUser(
		...
		if(!isValidUser){
			...
			user.setLasip(request.getRemoteAddr());
